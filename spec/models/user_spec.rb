...
describe User do
  ...
  it "should accept valid email addresses" do
    addresses = %w[user@foo.com the_user@users.org first.second@last.no]
  ...
  it "should reject invalid email addresses" do
    addresses = %w[user@foo,com the_user.org first.second@last]
    addresses.each do |address|
  ...
  describe "passwords encryptions" do
